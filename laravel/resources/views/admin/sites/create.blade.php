...
@section('content')
    ...
    <h3 class="page-title">@lang('global.sites.actions.create.title')</h3>

    {!! Form::open(['method' => 'POST', 'route' => ['admin.sites.store'], 'enctype' => "multipart/form-data"]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('site_name', old('site_name'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('organisation', Lang::get('global.sites.fields.tblOrganisation_idtblOrganisation.title')) !!}
                    <input type="text" id="organisation_search" size="100" class="form-control" placeholder="" />
                    <p class="help-block">
                        @lang('global.sites.fields.tblOrganisation_idtblOrganisation.helper')
                    </p>

                    {!! Form::hidden('organisation_latitude', null, ['id' => 'organisation_latitude']) !!}
                    {!! Form::hidden('organisation_longitude', null, ['id' => 'organisation_longitude']) !!}
                    {!! Form::hidden('organisation_place_id', null, ['id' => 'organisation_place_id']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                        {!! Form::label('organisation', Lang::get('global.organisation.fields.OrganisationState.title'), ['class' => 'control-label']) !!}
                        {!! Form::text('organisation_state', null, ['id' => 'organisation_state', 'size' => 100 , 'readonly' => 'true', 'class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                        {!! Form::label('country_code', Lang::get('global.sites.fields.tblISOtoCountry_ISOAlpha2.title'), ['class' => 'control-label']) !!}
                        {!! Form::select('country_code', $iso_to_country, 'AU', ['id' => 'country_code', 'readonly' => true, 'class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('meta[print-format]', array(
                        ...
                        ), 'standard', ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
